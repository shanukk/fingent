...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2021 at 10:25 AM
...
CREATE TABLE `invoice_item_details` (
  ...
  `sub_with_tax` float NOT NULL DEFAULT 0,
  `sub_without_tax` float NOT NULL DEFAULT 0,
...
CREATE TABLE `invoice_line_items` (
  `inv_li_id` int(11) NOT NULL,
  `inv_li_name` varchar(50) NOT NULL,
  `inv_li_price` double NOT NULL,
  `inv_li_tax` double NOT NULL,
  `inv_li_quantity` int(11) NOT NULL,
...
--
ALTER TABLE `invoice_line_items`
  MODIFY `inv_li_id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
